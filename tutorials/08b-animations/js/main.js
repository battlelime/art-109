...
function animate() {
    ...
    ball.position.x = Math.sin(Date.now() / 3000) * 2;
    ball.position.y = Math.sin(Date.now() / 1500) * 3;
    ball.position.z = Math.sin(Date.now() / 4500) * 2;
    //console.log(ball.position.x);

    if (dog) {
        //dog.rotation.x += 0.007;
        dog.rotation.y = Math.sin(Date.now() / 500);
    }
